...
data_dir = os.path.join(main_dir, '/home/row3na/Downloads/mosca_')
...
class Chimp(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image, self.rect = load_image('mosca2.png', -1)
...
################################################
    def _walk(self):
        ...
        newposy = self.rect.move((0, self.movey))
...
#Put Text On The Background, Centered
    if pygame.font:
        ...
        text = font.render("Mosca-tse-tse", 1, (10, 10, 10))
...
#Prepare Game Objects
    ...
    whiff_sound = pygame.mixer.Sound('inicial.wav')
    punch_sound = pygame.mixer.Sound('bonk.wav')
    #
